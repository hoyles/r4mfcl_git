plot.recruitment.betyft <- function(
plotdir="H:\\rmfcl\\test\\figs\\",plotrep=read(baserep),
varfile=NULL,nrow=5,legpos="topright")
{
##-----------------------------------------------------------------------
# SJH 20/1/2009
...
# read bounds from varfile for combined R
  ...
  for(i in 1:nplt){
    ...
    legend(legpos,legend=labs[i],cex=.7,bty="n")
    }
