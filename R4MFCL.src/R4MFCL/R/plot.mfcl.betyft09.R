...
lines(c(120,210),c(20,20),lty=1,lwd=2)
lines(c(120,210),c(-10,-10),lty=1,lwd=2)

text(c(rep(150,3),rep(190,3)),c(33,10,-15,33,10,-15),labels=as.character(c(1,3,5,2,4,6)),cex=1.2)
